export const CubicInput = () => {
  return (
    <>
      ...
      <form className="form-container grid grid-cols-5 gap-x-5 justify-self-center" id="cubic">
        <div className="flex flex-col items-center">
          <label className="text-yellow-800 mb-4">a value:</label>
          <input type="number" className="border-5 border-yellow-700 border-double" required />
        </div>
        <div className="flex flex-col items-center">
        ...
        <input type="submit" value="Save!" className="form-submit text-yellow-700 bg-amber-300" />
      </form>
    </>
  );
};
